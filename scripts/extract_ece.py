...
### Extension note: ###
#
# Code follows the "extract_accuracy.py" script as in the FixMatch repository, but for ECE tags.
#
...
def main(argv):
    ...
    assert accuracies, 'No "ece" tag found. Found tags = %s' % tags
    target_dir = os.path.join(folder, 'stats')
    target_file = os.path.join(target_dir, 'ece.json')
