### Extension note: ###
#
# We have added an epoch-wise expected calibration error (ECE) calculation besides accuracies.
#
...
from cssl_utils import calculate_ece
...
class ClassifySemi(Model):
    ...
    def add_summaries(self, feed_extra=None, **kwargs):
        ...
        tf.summary.scalar('ece', accuracies[5])
